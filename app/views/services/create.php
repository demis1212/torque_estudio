...
<head>
    ...
    <title>Nuevo Servicio - Torque Studio ERP</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form method="POST" action="<?= $basePath ?>/services/create">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" placeholder="Describe el servicio..."></textarea>
                </div>
