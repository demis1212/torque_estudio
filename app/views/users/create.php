...
<head>
    ...
    <title>Nuevo Usuario - Torque Studio ERP</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="<?= $basePath ?>/users/create">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="hourly_rate" id="hourly_rate" min="0" step="1" placeholder="Ej: 25000">
                </div>
