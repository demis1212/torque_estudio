...
<head>
    ...
    <title>Editar Cliente - Torque Studio ERP</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="card">
            <form action="<?= $basePath ?>/clients/edit/<?= esc($client['id']) ?>" method="POST">
                ...
                <div class="form-group">
                    <label>RUT</label>
                    <input type="text" name="rut" value="<?= esc($client['rut'] ?? '') ?>" placeholder="12.345.678-9">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="whatsapp" value="<?= esc($client['whatsapp'] ?? '') ?>" placeholder="+56912345678">
                </div>

                <div class="form-group">
                    <label style="text-transform:none; letter-spacing:normal; font-family:'Inter', sans-serif;">
                        <input type="checkbox" name="whatsapp_opt_in" value="1" style="width:auto; margin-right:8px;" <?= !empty($client['whatsapp_opt_in']) ? 'checked' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <textarea name="address" rows="3"><?= esc($client['address'] ?? '') ?></textarea>
                </div>
