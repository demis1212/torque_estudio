...
<head>
    ...
    <title>Nuevo Vehículo - Torque Studio ERP</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form method="POST" action="<?= $basePath ?>/vehicles/create">
                ...
                <div class="form-group">
                    ...
                    <select name="client_id" id="client_id" required>
                        ...
                        <?php foreach ($clients as $client): ?>
                            <option value="<?= $client['id'] ?>"><?= esc($client['name']) ?> - <?= esc($client['phone'] ?? 'Sin teléfono') ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="vin" id="vin" required maxlength="50">
                    </div>
                    <div class="form-group">
                        <label for="plate">Placa</label>
                        <input type="text" name="plate" id="plate" maxlength="20">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="brand" id="brand" required maxlength="50">
                    </div>
                    <div class="form-group">
                        <label for="model">Modelo *</label>
                        <input type="text" name="model" id="model" required maxlength="50">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="color" id="color" maxlength="50">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="year" id="year" required min="1900" max="2030">
                    </div>
                    <div class="form-group">
                        <label for="engine">Motor</label>
                        <input type="text" name="engine" id="engine" maxlength="50">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="notes" id="notes" maxlength="255" placeholder="Observaciones iniciales">
                </div>
