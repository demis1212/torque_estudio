...
<head>
    ...
    <title>Asignar Herramienta - Torque Studio ERP</title>
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <h1>🔧 Asignar Herramienta a Mecánico</h1>
        </div>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="<?= $basePath ?>/tools/mechanic/create">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" placeholder="Ej: Juego de llaves mixtas" required>
                </div>

                <div class="form-group">
                    <label>Código</label>
                    <input type="text" name="code" placeholder="Ej: HM-001">
                </div>

                <div class="form-group">
                    <label>Marca</label>
                    <input type="text" name="brand" placeholder="Ej: Stanley">
                </div>

                <div class="form-group">
                    <label>Modelo</label>
                    <input type="text" name="model" placeholder="Ej: 8-19mm">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" placeholder="Detalles de la herramienta..."></textarea>
                </div>
                ...
                <button type="submit" class="btn-primary">Asignar Herramienta</button>
                <a href="<?= $basePath ?>/tools/mechanic" class="btn-secondary">Cancelar</a>
            </form>
        </div>
    </div>
</body>
